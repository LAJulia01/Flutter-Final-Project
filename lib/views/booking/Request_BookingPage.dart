...
class BookingRequestPageState extends State<BookingRequestPage> {
  ...
  final String _fcmServerKey =
      '263cfc12c2e7a3481d9666e9ed1fc11a15e18321'; // Replace with actual key
  ...
  Future<void> confirmBooking(BuildContext context) async {
    try {
      ...
      // Show local notification with booking details
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Booking confirmed! Check your notifications.')),
      );
    } catch (e) {
...
// Updated _showLocalNotification method
...
Future<void> _showLocalNotification() async {
  ...
  const NotificationDetails platformChannelSpecifics =
    ...
    // Prepare the booking details for the notification

    String bookingDetails =
        'Your booking has been confirmed for ${addressController.text}.\n'
    ...
    await flutterLocalNotificationsPlugin.show(
      ...
      payload: jsonEncode({
        ...
        'date': selectedDate != null
            ...
            : 'Not set',
        'start_time':
            startTime != null ? startTime!.format(context) : 'Not set',
        'end_time': endTime != null ? endTime!.format(context) : 'Not set',
